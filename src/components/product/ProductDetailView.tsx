...
export function ProductDetailView() {
  ...
  const productReviewsCount = reviews.filter(r => r.productId === product.id).length;
  ...
  const isLowStock = product.inStock && product.stockCount > 0 && product.stockCount <= LOW_STOCK_THRESHOLD;
  ...
  const relatedProducts = products
    .filter(p => p.isActive !== false && p.id !== product.id && p.category === product.category)
    .slice(0, 4);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 pb-14 border-b border-[#E6E4E0]">
        ...
        <div className="lg:col-span-7 flex flex-col-reverse sm:flex-row gap-4">
          ...
          <div className="relative flex-1 aspect-square rounded-3xl bg-white overflow-hidden border border-[#E6E4E0] shadow-xs flex items-center justify-center">
            ...
            {isAuthenticated && (
              <div className="absolute top-4 left-4 px-3 py-1.5 rounded-xl bg-emerald-600 text-white text-xs font-bold uppercase tracking-wider shadow-sm flex items-center gap-1.5">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            {isAuthenticated ? (
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-5 shadow-xs space-y-3 text-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-600 mt-1 max-w-sm mx-auto">
                    Sign in with your free reseller account to view supplier prices, exact profit per sale, and generate 1-click landing pages.
                  </p>
                </div>
                <div className="pt-1">
                  <button
            ...
            {isAuthenticated ? (
              ...
              >
                <span>Start Selling This Product (No Upfront Inventory)</span>
