...
export function Header() {
  ...
  return (
    <header className="w-full max-w-full bg-white border-b border-[#E6E4E0] sticky top-0 z-50">
      ...
      <div className="w-full max-w-[1800px] mx-auto px-3.5 sm:px-5 lg:px-8 xl:px-10 py-2.5 sm:py-3.5 relative z-20">
        <div className="flex items-center justify-between gap-2 sm:gap-4 lg:gap-8">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
            <button
              ...
              className="lg:hidden p-1.5 -ml-1 text-neutral-700 hover:text-black rounded-lg hover:bg-neutral-100 transition-colors"
          ...
          <div className="flex items-center gap-1 sm:gap-2.5 shrink-0">
            ...
            <div className="relative" ref={accountRef}>
              <button
                ...
                className="flex items-center gap-1.5 p-1 sm:p-2 rounded-full hover:bg-[#F7F6F3] transition-colors text-neutral-800"
                aria-label="Account menu"
              >
                {isAuthenticated && (user?.photoURL || userProfile?.photoURL) ? (
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full overflow-hidden border border-[#E6E4E0] shrink-0">
                    <img 
                  ...
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#F2EEE7] flex items-center justify-center text-neutral-800 font-semibold text-xs border border-[#E6E4E0] shrink-0">
                    {isAuthenticated ? (
                ...
                <div className="hidden xl:flex flex-col text-left leading-tight">
                  ...
                  <span className="text-[13.5px] font-bold text-[#111111] capitalize truncate max-w-[120px]">
              ...
              {isAccountMenuOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl border border-[#E6E4E0] shadow-xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                  {isAuthenticated ? (
                    <>
                      <div className="px-4 py-3 border-b border-neutral-100">
                        <p className="text-sm font-bold text-neutral-900 truncate">
                          {userProfile?.firstName ? `${userProfile.firstName} ${userProfile.lastName}` : (user?.displayName || 'Zero Invest Member')}
                        </p>
                        <p className="text-xs text-neutral-500 truncate">{user?.email || userProfile?.email || user?.phoneNumber}</p>
                        <div className="mt-2 flex items-center gap-1.5 flex-wrap">
                          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#EAD7CA]/50 text-[#111111] uppercase tracking-wider">
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-2.5 text-xs sm:text-[13.5px] font-medium text-neutral-700 hover:bg-[#F7F6F3] hover:text-neutral-900 flex items-center justify-between"
                      >
                      ...
                      <button
                        onClick={() => {
                          setIsAccountMenuOpen(false);
                          navigate(isUserReseller ? 'reseller-dashboard' : 'reseller');
                        }}
                        className="w-full text-left px-4 py-2.5 text-xs sm:text-[13.5px] font-medium text-neutral-700 hover:bg-[#F7F6F3] hover:text-neutral-900 flex items-center justify-between"
                      >
                        <span className="flex items-center gap-2">
                          <Store className="w-4 h-4 text-[#C98F6B]" />
                          {isUserReseller ? 'Reseller Portal' : 'Start Selling (Reseller)'}
                        </span>
                      </button>
                      ...
                      {isUserAdmin && (
                        <button
                          ...
                          className="w-full text-left px-4 py-2.5 text-xs sm:text-[13.5px] font-semibold text-neutral-900 hover:bg-[#F7F6F3] flex items-center justify-between"
                        >
                          <span className="flex items-center gap-2">
                      ...
                      <div className="border-t border-neutral-100 mt-1 pt-1">
                        <button
                          ...
                          className="w-full text-left px-4 py-2 text-xs sm:text-[13px] text-neutral-600 hover:bg-[#F7F6F3]"
                        >
                          Track Active Orders
                        </button>
                        <button
                          ...
                          className="w-full text-left px-4 py-2.5 text-xs sm:text-[13px] font-semibold text-rose-600 hover:bg-rose-50 flex items-center gap-2"
                        >
                    ...
                    <>
                      <div className="px-4 py-3 border-b border-neutral-100">
                        <p className="text-sm font-bold text-neutral-900">Zero Invest Member</p>
                        <p className="text-xs text-neutral-500 mt-0.5">Sign in for personalized shopping and express checkout.</p>
                        <div className="mt-3 flex gap-2">
                          <button
                            ...
                            className="flex-1 py-2 px-3 bg-[#111111] hover:bg-neutral-800 text-white rounded-xl text-xs font-bold text-center transition-colors shadow-2xs"
                          >
                            Sign In
                          </button>
                          <button
                            ...
                            className="flex-1 py-2 px-3 bg-white border border-[#E6E4E0] hover:bg-[#F7F6F3] text-neutral-800 rounded-xl text-xs font-bold text-center transition-colors"
                          >
                            Register
                          </button>
                        </div>
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-2.5 text-xs sm:text-[13px] font-medium text-neutral-700 hover:bg-[#F7F6F3] flex items-center gap-2"
                      >
                      ...
                      >
                        ...
                        <span>Track an Order as Guest</span>
                      </button>
                      ...
                      <div className="border-t border-neutral-100 mt-1 pt-1">
                        <button
                          ...
                          className="w-full text-left px-4 py-2 text-xs sm:text-[13px] text-neutral-600 hover:bg-[#F7F6F3] flex items-center gap-2"
                        >
            ...
            <button
              ...
              className="relative p-1.5 sm:p-2 text-neutral-800 hover:text-black rounded-full hover:bg-[#F7F6F3] transition-colors flex items-center gap-1.5 shrink-0"
              aria-label="Wishlist"
              title="View Wishlist"
            >
              ...
              {wishlist.length > 0 && (
                <span className="absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full bg-[#111111] text-white text-[10px] font-bold flex items-center justify-center">
                  {wishlist.length}
                </span>
              )}
            </button>

            {/* Reseller Quick Action (Replaces Cart) */}
            {isUserReseller ? (
              <button
                onClick={() => navigate('reseller-dashboard')}
                className="flex items-center gap-1.5 sm:gap-2 bg-[#111111] hover:bg-neutral-800 text-white rounded-full py-1.5 px-3 sm:py-2.5 sm:px-4 text-xs sm:text-[13.5px] font-bold transition-all shadow-xs shrink-0 cursor-pointer"
      ...
      <div className="border-t border-[#E6E4E0] bg-white w-full max-w-full relative z-0">
