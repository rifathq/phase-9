        ...
        <div className="bg-white py-8 px-6 sm:px-10 shadow-sm border border-[#E6E4E0] rounded-3xl">
          ...
          {isForgotMode ? (
            ...
            <div className="space-y-6">
              {/*
                TEMPORARILY DISABLED: Google Sign-In is disabled in the UI because Firebase returns
                auth/unauthorized-domain inside the Google AI Studio Preview environment.
                All underlying Firebase GoogleAuthProvider integration and handler code remains intact
